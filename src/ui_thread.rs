...
// This is the main UI file of RPFM. Here is the main loop that builds the UI and controls his events.
...
use qt_core::qt::{ContextMenuPolicy, Orientation, ShortcutContext, SortOrder, WindowState};
...
lazy_static! {
    ...
    pub static ref TREEVIEW_ICONS: Icons = Icons::new();
    ...
    pub static ref IS_MODIFIED: Arc<Mutex<bool>> = Arc::new(Mutex::new(false));
    ...
    pub static ref TABLE_STATES_UI: Mutex<BTreeMap<Vec<String>, TableStateUI>> = Mutex::new(TableStateUI::load().unwrap_or_else(|_| TableStateUI::new()));
}

/// Custom type to deal with QStrings more easely.
pub type QString = qt_core::string::String;
